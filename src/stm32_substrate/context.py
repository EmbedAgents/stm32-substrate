...
_log = logging.getLogger("stm32_substrate.context")
...
class SubstrateContext:
    ...
    def from_environment(
        ...
        *,
        ...
        logger = logging.getLogger("stm32_substrate")
...
def _load_schema(schema_name: str) -> dict[str, Any]:
    ...
    pkg = resources.files("stm32_substrate.schemas")
...
def _build_svd_db(tools: ToolPaths) -> Any:
    ...
    from stm32_substrate.debug.svd import SvdDb, resolve_svd_roots
