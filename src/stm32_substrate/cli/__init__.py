...
from stm32_substrate import __version__
from stm32_substrate.cli import _build, _debug, _mx, _prog, _vcp
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--version",
        action="version",
        version=f"stm32-substrate {__version__}",
    )
    parser.add_argument(
        "--pretty",
        action="store_true",
...
def _configure_logging(verbosity: int) -> None:
    ...
    root = logging.getLogger("stm32_substrate")
